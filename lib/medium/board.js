...
JGO.BOARD.medium = {
    textures: {
        black: '../lib/medium/black.png',
        white: '../lib/medium/white.png',
        shadow:'../lib/medium/shadow.png',
        board: '../lib/medium/shinkaya.jpg'
    },
...
JGO.BOARD.mediumWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.medium), {
    textures: {board: '../lib/medium/walnut.jpg', shadow: '../lib/medium/shadow_dark.png'},
